...
class Noter:
    ...
    def log_train(self, loss, hr, mrr, ndcg, elapse):
        ...
        self.elapse = elapse
        print('\n\t| Train | loss {loss: 8.5f} | hr {hr: 8.4f} | mrr {mrr: 8.4f} | ndcg {ndcg: 8.4f} | '
              '{elapse:3.4f} min'
    ...
    def log_val(self, epoch, loss, hr, mrr, ndcg, set_log=True):
        ...
        print('\n\t| Valid | loss {loss: 8.5f} | hr {hr: 8.4f} | mrr {mrr: 8.4f} | ndcg {ndcg: 8.4f} |'
        ...
        if mode == 'test':
            with open(self.log, 'a') as f:
                f.write('\n[Info] Test set result -> loss: {loss: 8.5f}, hr:{hr: 8.4f}, mrr:{mrr: 8.4f}, '
                        ...
                        .format(loss=loss, hr=hr, mrr=mrr, ndcg=ndcg))
            print('\n[Testing]')
            print('\n\t| Test | loss{loss: 8.5f} | hr {hr: 8.4f} | mrr {mrr: 8.4f} | ndcg:{ndcg: 8.4f} |'
                  .format(loss=loss, hr=hr, mrr=mrr, ndcg=ndcg))
